...
if(!isset($_GET["id"])){
    ...
    if($id == "" ||$id == null){
        ...
        //busco el producto
        $datos = $conexion->query("SELECT id_producto,codigo,nombre_producto,sku,id_moneda,iva,id_unidad_medida,
        costo_inicial,
        P.clave_cfdi,
        P.unidad_cfdi,
        P.id_tipo_producto,
        P.descripcion,
        CONCAT(P.clave_cfdi,' - ',CC.descripcion) as descripcion_clave,
        CONCAT(P.unidad_cfdi,' - ',UC.nombre) as descripcion_unidad
        FROM productos as P
        INNER JOIN claves_cfdi as CC ON P.clave_cfdi = CC.clave_cfdi
        INNER JOIN unidades_cfdi as UC ON P.unidad_cfdi = UC.c_clave_unidad
        WHERE id_producto = $id AND P.activo = 1");
...
<body class="fix-sidebar fix-header card-no-border">
                                        ...
                                        <div class="tab-pane active show container" id="home" role="tabpanel">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <input type="text" name="codigo" id="codigo" value="<?php echo $row_datos["codigo"];?>" class="form-control" required="required">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="titulo">Título:</label>
                                                    <input type="text" name="titulo" id="titulo" class="form-control" value="<?php echo $row_datos["nombre_producto"];?>" required="required">
                                                </div>
                                                <div class="col-md-4 form-group">
                                                        <label for="sku" class="control-label">SKU:</label>
                                                        <input type="text" name="sku" id="sku" class="form-control" required="required" value="<?php echo $row_datos["sku"];?>">
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 form-group">
                                                    ...
                                                    <input type="number" min=0 name="costo_inicial" id="costo_inicial" value="<?php echo $row_datos["costo_inicial"];?>" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4 form-group">
                                                    ...
                                                    <option value="<?php echo $row_datos["clave_cfdi"];?>" selected="selected"><?php echo $row_datos["descripcion_clave"];?></option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="unidad_cfdi" class="control-label">Unidad CFDI:</label>
                                                    <select name="unidad_cfdi" id="unidad_cfdi" class="form-control">
                                                    <option value="<?php echo $row_datos["unidad_cfdi"];?>" selected="selected"><?php echo $row_datos["descripcion_unidad"];?></option>
                                                    </select>
                                                </div>
                                                <div class="col-md-4 form-group">
                                                    <label for="tipo_producto" class="control-label">Tipo de uso:</label>
                                                    <select name="id_tipo_producto" id="tipo_producto" class="form-control">
                                                    <?php
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea name="descripcion" id="descripcion" cols="30" rows="5" class="form-control"><?php echo $row_datos["descripcion"];?></textarea>
                                                </div>
                                            </div>
                                            <br>
                                        </div>
                                                                        ...
                                                                        while($row_precios = $precios->fetch(PDO::FETCH_NUM)){
                                                                            ...
                                                                            <tr>
                                                                                <td class="text-center">
                                                                                    <input type="hidden" name="precios_bd[]" value="<?php echo $row_precios[0];?>">
                                                                                    <input type="text" name="nombre_precios[]" id="" value="<?php echo $row_precios[1];?>" class="form-control">
                                                                                </td>
                                                                                <td class="text-center"><input type="number" name="precios[]" step="any" id="" min=0 value="<?php echo $row_precios[2];?>" class="form-control"></td>
                                                        ...
                                                        <table class="table table-bordered table-striped table-condensed table-hover color-table info-table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while($row_almacenes = $almacenes->fetch(PDO::FETCH_NUM)){
                                                                    ...
                                                                    //busco el registro de los precios
                                                                    $buscar_existencias = $conexion->query("SELECT id_existencia,id_almacen,minimo,maximo,stock,ubicacion
                                                                    FROM existencias_almacenes
                                                                    WHERE id_almacen = $id_almacen AND id_producto = $id");
                                                                    $existe_registro = $buscar_existencias->rowCount();
                                                                    if($existe_registro == 0){
                                                                        //apenas se insertara
                                                                        ?>
                                                                        <tr>
                                                                            <td class="text-center"><?php echo $almacen;?><input type="hidden" name="almacenes[]" value="<?php echo $id_almacen;?>"></td>
                                                                            <td class="text-center"><?php echo $sucursal;?></td>
                                                                            <td class="text-center"><?php echo $direccion;?></td>
                                                                            <td class="text-center"><input type="number" name="minimos[]" id="minimo" class="form-control" value=0></td>
                                                                            <td class="text-center"><input type="number" name="maximos[]" id="minimo" class="form-control" value=0></td>
                                                                            <td class="text-center"><input type="number" name="inventario_inicial[]" id="minimo" class="form-control" value=0></td>
                                                                            <td class="text-center"><input type="text" name="ubicaciones[]" id="minimo" class="form-control"></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                    else{
                                                                        $row_existencia = $buscar_existencias->fetch(PDO::FETCH_NUM);
                                                                        $id_existencia = $row_existencia[0];
                                                                        $minimo = $row_existencia[2];
                                                                        $maximo = $row_existencia[3];
                                                                        $stock = $row_existencia[4];
                                                                        $ubicacion = $row_existencia[5];
                                                                        ?>
                                                                        <tr>
                                                                        <input type="hidden" name="almacenes_guardados[]" value="<?php echo $id_almacen;?>">
                                                                        <input type="hidden" name="existencias[]" value="<?php echo $id_existencia;?>">
                                                                            <td class="text-center"><?php echo $almacen;?><input type="hidden" name="almacenes[]" value="<?php echo $id_almacen;?>"></td>
                                                                            <td class="text-center"><?php echo $sucursal;?></td>
                                                                            <td class="text-center"><?php echo $direccion;?></td>
                                                                            <td class="text-center"><input type="number" name="minimos[]" id="minimo" class="form-control" value="<?php echo $minimo;?>"></td>
                                                                            <td class="text-center"><input type="number" name="maximos[]" id="minimo" class="form-control" value="<?php echo $maximo;?>"></td>
                                                                            <td class="text-center"><input type="number" name="inventario_inicial[]" id="minimo" class="form-control" value="<?php echo $stock;?>"></td>
                                                                            <td class="text-center"><input type="text" name="ubicaciones[]" id="minimo" class="form-control" value="<?php echo $ubicacion;?>"></td>
                                                                        </tr>
                                                                        <?php
                                                                    }
                                                                    ?>
    ...
    <script type="text/javascript">
        ...
        <?php
                ...
                ?>
             $("#moneda").val("<?php echo $row_datos['id_moneda'];?>");
             $("#iva").val("<?php echo $row_datos['iva'];?>");
             $("#unidad_medida").val("<?php echo $row_datos['id_unidad_medida'];?>");
             $("#tipo_producto").val("<?php echo $row_datos['id_tipo_producto'];?>");
    </script>
