                        ...
                        <div class="col-12">
                            <div class="card card-outline-info">
                                <div class="card-header">
                                    <strong><span class="text-white">Agregar auditoría</span></strong>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <input type="text" name="fecha_apertura" fechas required id="fecha_apertura" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="fecha_cierre" class="control-label" style="font-weight:bold">Fecha de cierre: </label>
                                            <input type="text" name="fecha_cierre" required fechas id="fecha_cierre" autocomplete="off" class="form-control">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="objetivo" class="control-label" style="font-weight:bold">Objetivo: </label>
                                            <textarea name="objetivo" id="objetivo" cols="30" rows="5" required class="form-control"></textarea>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label for="criterio" class="control-label" style="font-weight:bold">Criterio: </label>
                                            <textarea name="criterio" id="criterio" cols="30" rows="5" required class="form-control"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" class="btn btn-success btn-block">Crear auditoria</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
