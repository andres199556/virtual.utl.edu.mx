                        ...
                        <div class="card card-outline-info">
                           <div class="card-header">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                    <input type="hidden" name="tipo" value="primer_acceso">
                                        <div class="col-md-3 form-group">
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="col-md-3 form-group">
                                                        ...
                                                        <input type="text" name="password" required placeholder="123456" id="password" class="form-control" value="123456">
                                                    </div>
                            ...
                            <div class="card-footer">
                                ...
                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-2">
                                                        <a href="../sesion/cerrar_sesion.php"  class="btn btn-danger btn-block">Cancelar</a>
                                                    </div>
                                                    <div class="col-md-2">
