...
left join trabajadores as T ON P.id_persona = T.id_persona
    ...
    $array_resultado["mensaje"] = "El usuario no existe en el sistema";
        ...
        if($primer_acceso == 1){
            ...
            session_name("session_activa_sixara");
            session_start();
            $array_resultado["id_usuario"] = $id_usuario;
            $array_resultado["id_persona"] = $id_persona;
            $array_resultado["nombre_persona"] = $nombre_persona;
            $array_resultado["usuario"] = $usuario;
            $array_resultado["correo"] = $correo;
            $array_resultado["nombre_corto"] = $nombre_corto;
            $array_resultado["id_trabajador"] = $id_trabajador;
            $array_resultado["sesion_activa"] = "SI";
            $array_resultado["ultimo_acceso"] = date("Y-m-d H:i:s");
            ...
            $array_resultado["fotografia"] = $fotografia;
        }
