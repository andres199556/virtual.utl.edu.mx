                        ...
                        <div class="card card-outline-info">
                           <div class="card-header">
                            ...
                            <div class="card-body">
                                <ul class="timeline">
                                <li class="timeline">
                                <div title="28 de Agosto del 2019 10:03 A.M." data-toggle="tooltip" class="timeline-badge success time-left"><i class="fa fa-hourglass-start"></i> </div>
                                <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4 class="timeline-title">Sistema administrador</h4>
                                                <p><small class="text-muted"><i class="fa fa-clock-o"></i> Administrador del sistema</small> </p>
                                            </div>
                                            <div class="timeline-body">
                                                <p>Se ha creado la tarea.</p>
                                            </div>
                                        </div>
                                </li>
                                <li class="timeline-inverted">
                                        <div title="28 de Agosto del 2019 04:23 P.M." data-toggle="tooltip" class="timeline-badge warning time-right"><i class="fa fa-comment"></i> </div>
                                        <div class="timeline-panel">
                                            <div class="timeline-heading">
                                                <h4 class="timeline-title">Willy de León</h4>
                                                <p><small class="text-muted"><i class="fa fa-comment-o"></i> willy.deleon@utl.edu.mx</small> </p>
                                            </div>
                                            <div class="timeline-body">
                                                <p>Se realizó la instalación solo en 11 aulas.</p>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
...
Date.prototype.timeNow = function () {
     return ((this.getHours() < 10)?"0":"") + this.getHours() +":"+ ((this.getMinutes() < 10)?"0":"") + this.getMinutes() +":"+ ((this.getSeconds() < 10)?"0":"") + this.getSeconds();
        ...
        $(".time-right").tooltip({placement: 'left',trigger: 'manual'}).tooltip('show');
        $(".time-left").tooltip({placement: 'right',trigger: 'manual'}).tooltip('show');
    </script>
</body>
</html>