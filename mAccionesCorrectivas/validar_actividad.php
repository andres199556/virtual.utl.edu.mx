...
try{
    ...
    SET activo = 0,
    comentarios_verificador = '$motivo',
    fecha_verificacion = '$fecha',
    usuario_verifico = $id_usuario_logueado
    WHERE id_actividad = $id");
    //inserto el log
    $log = "Se ha liberado la actividad con el N° $id de la acción correctiva N° $id_accion a la fecha $fecha, realizó: ".$_SESSION["nombre_persona"];
    $insert_log = $conexion->query("INSERT INTO historial_acciones(
        ...
        //envio el correo
        $asunto = "La actividad ha sido liberada";
        $cuerpo = "<p>El siguiente correo es para notificar que la actividad llamada \"$actividad\" dentro de la acción correctiva N° $id_accion ha sido verificada y aprobada, los detalles son los siguientes: </p>
    <p><b>Acción n°</b>: $id_accion</p>
    <p><b>Actividad:</b> $actividad</p>
    <p><b>Estado:</b> Aprobada</p>
    <p><b>Comentarios:</b> $motivo</p>
    ...
    $resultado["mensaje"] = "Actividad liberada correctamente!.";
