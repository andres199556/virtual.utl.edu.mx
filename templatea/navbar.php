                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?php echo $_SESSION["nombre_corto"];?></h4>
                                                <?php
                                                if($_SESSION["correo"] == "" || $_SESSION["correo"] == null){
                                                    ...
                                                    ?>
                                                    <p class="text-muted"><?php echo $_SESSION["correo"];?></p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                                    <?php
                                                }
                                                ?>
