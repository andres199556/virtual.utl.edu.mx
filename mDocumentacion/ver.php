                        ...
                        <div class="col-12">
                            <div class="card card-outline-inverse">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white"><i class="mdi mdi-cube"></i> Historial de versiones</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                <table class="table-hover table table-striped table-condensed">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center th-header">#</th>
                                                            <th class="text-center th-header">Título</th>
                                                            <th class="text-center th-header">Versión</th>
                                                            <th class="text-center th-header">Comentarios</th>
                                                            <th class="text-center th-header">Fecha de vigencia</th>
                                                            <th class="text-center th-header">Responsable</th>
                                                            <th class="text-center th-header">Descargar</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php
                                                        $detalles = $conexion->query("SELECT
                                                    ...
                                                    WHERE
                                                        ...
                                                        $n = 0;
                                                        while($row = $detalles->fetch(PDO::FETCH_ASSOC)){
                                                            $n++;
                                                            ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><a href="download.php?file=<?php echo $row['file_string'];?>" class="btn btn-sm btn-success" title="Descargar" data-toggle="tooltip"><i class="fa fa-download"></i></a></td>
                                                            </tr>
                                                            <?php
                                                        }
                                                        ?>
