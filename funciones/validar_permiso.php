...
$buscar_permiso = $conexion->prepare("SELECT permiso_modulo FROM permiso_modulos PM INNER JOIN modulos as M ON PM.id_modulo = M.id_modulo WHERE PM.id_usuario = $id_usuario_logueado AND M.carpeta_modulo = '$menu'");
