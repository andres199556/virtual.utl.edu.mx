                        ...
                        <div class="col-12">
                            <div class="card card-outline-inverse">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white"><i class="mdi mdi-cube"></i> Agregar departamento</h4>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3 form-group">
                                            <label for="nombre" class="control-label">Departamento: </label>
                                            <input type="text" name="departamento" required id="departamento" class="form-control">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="siglas" class="control-label">Siglas: </label>
                                            <input type="text" name="siglas" required id="siglas" class="form-control">
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label for="direccion" class="control-label">Dirección: </label>
                                            <select name="direccion" required id="direccion" class="form-control">
                                            <?php
