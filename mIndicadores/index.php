                        ...
                        <div class="card">
                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table
                                                                            ...
                                                                            <tbody
                                                                                ...
                                                                                INNER JOIN personas AS P ON U.id_persona = P.id_persona
                                                                                WHERE
                                                                                    I.id_direccion = $id_direccion AND I.activo = 1";
                                                                                }
                                                                                else{
                                                                                    $qry = "SELECT
                                                                                    id_indicador,
                                                                                ...
                                                                                INNER JOIN personas AS P ON U.id_persona = P.id_persona
                                                                                WHERE
                                                                                    I.id_direccion = $id_direccion AND I.id_responsable = $id_usuario_logueado AND I.activo = 1";
                                                                                }
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <?php
                                                                                        if($permiso_acceso == 1){
                                                                                            ?>
                                                                                    <td class="text-center">
                                                                                        <a href="editar.php?id=<?php echo $row_i[0]; ?>"
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <a href="historial.php" class="btn btn-info btn-block"><i
                                                class="fa fa-history"></i> Historial de indicadores</a>
                                    </div>
                                    <div class="col-md-2">
                                        <a href="alta.php" class="btn btn-success btn-block">Agregar indicador</a>
                                    </div>
                                </div>
                            </div>
                        </div>
